...
const decodeUint8 = (buffer: ArrayBuffer): number => new DataView(buffer).getUint8(0);
...
const buffer = new Uint8Array([
  0x10, 0x08,       // Sequence tag and length
  0x02, 0x01, 0x1e, // age: 30
  0x0c, 0x05, 0x41, 0x6c, 0x69, 0x63, 0x65 // name: "Alice"
]).buffer;
